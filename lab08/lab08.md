...
Передавал чанками по 512 байт файл размером 2Кб
...
Сделал порчу пакетов с вероятностью 10%. Видно, что со стороны клиента данные 1 раз закорраптились, однако файл восстановился корректно.
